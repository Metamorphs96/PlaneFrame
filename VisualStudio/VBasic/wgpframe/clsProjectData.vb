...
#Const isUsingExcel = 0
    ...
    Sub cprint()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & HdrTitle1
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & LoadCase
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ProjectID
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Author
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & runNumber
    End Sub
    ...
    Sub fgetData(ByVal fp As Integer)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "fgetData ..."
