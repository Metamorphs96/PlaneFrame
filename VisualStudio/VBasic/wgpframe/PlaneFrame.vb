...
Public Class PlaneFrame
    ...
    'Vectors
    Public mlen(v_size) As Double                       '.. member length ..
    ...
    Public dj(v_size) As Double                         '.. joint displacements @ ALL the nodes ..
    Dim ad(v_size) As Double                         '.. member end forces not including fixed end forces ..
    Dim ar(v_size) As Double                         '.. support reactions ..

    'Matrices
    Public rot_mat(v_size, ndx2) As Double              '.. member rotation  matrix ..
    ...
    Public mom_spn(max_grps, n_segs) As Double  '.. member span moments ..
    ...
    Private Sub Choleski_Decomposition(ByRef sj(,) As Double, Byval ndof As Integer, Byval hbw As Integer)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Choleski_Decomposition ...")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("ndof, hbw" + format(ndof,"0") + format( hbw,"0"))
        ...
        For global_i = baseIndex To ndof - 1 'From first to last index of array: rows of matrix
            frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("global_i=" + format( global_i,"0"))
            ...
            frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("p=" +format( p,"0"))
            ...
            For global_j = baseIndex To p
                ...
                frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("q=" + format(q,"0"))
                ...
                frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("su = " + Format(su, "0.0000"))

                If q >= 0 Then 'valid array index and not first element of array
                    '              frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "Testing: Valid Array Index"
                ...
                Else 'is first element
                    If su <= 0 Then
                        ...
                        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Choleski_Decomposition: matrix -ve TERM Terminated ???")
                        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Cannot find square root of negative number")
                        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("su = " + format( su,"0.0000"))
                        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("global_i, global_j : " + format(global_i,"0") + " " + format(global_j,"0"))
                    ...
                    Else 'First Element
                        '                frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "Testing Index: su>0"
                        te = 1 / Sqrt(su)

                        '                te = 1 'testing
                        sj(global_i, global_j) = te                        'Over write original matrix
                        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("te = " + format( te,"0.0000"))
...
ErrHandler_Choleski_Decomposition:
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("ERRORS: ")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("--------------------------------------------------------------")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Choleski_Decomposition: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number - vbObjectError, "0") & Err.Description
        Err.Clear()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("--------------------------------------------------------------")
    ...
    Private Sub Fill_Restrained_Joints_Vector()
        ...
        For global_i = baseIndex To GModel.structParam.nrj - 1
            With GModel.sup_grp(global_i)
                ...
                rjl(j3 - 1) = .ry
                rjl(j3) = .rm
                frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("rjl.. " + format( rjl(j3 - 2),"0.0000") + " " + format( rjl(j3 - 1),"0.0000") + " " +  format(rjl(j3),"0.0000"))
            End With
        Next global_i
        ...
        For global_i = baseIndex + 1 To n3 - 1
            ...
            frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("crl.. " + format( crl(global_i),"0"))
        Next global_i

        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Fill_Restrained_Joints_Vector n3, nn, nr .. " + Format(n3, "0") + Format(nn, "0") + Format(GModel.structParam.nr, "0"))
    ...
    Private Sub Calc_Bandwidth()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Calc_Bandwidth hbw, nn .. " = format( hbw,"0") + " " + format( nn,"0"))
    ...
    Private Sub Assemble_Stiff_Mat(ByVal i As Byte)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Assemble_Stiff_Mat ...")

        Call Get_Stiff_Elements(i)

        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("eaol: " + format(eaol,"0.0000"))
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("cosa: " + format(cosa,"0.0000"))
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("sina: " + format(sina,"0.0000"))
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("ccl: " + format(ccl,"0.0000"))
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("ci: " + format(ci,"0.0000"))
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("cj: " + format(cj,"0.0000"))
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("ai: " + format(ai,"0.0000"))
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("ao2: " + format(ao2,"0.0000"))
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("aj: " + format(aj,"0.0000"))
    ...
    Private Sub Assemble_Global_Stiff_Matrix(ByVal i As Byte)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Assemble_Global_Stiff_Matrix ...")
        ...
        '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "eaol :", eaol)
        '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "cosa :", cosa)
        '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "sina :", sina)
        '
        '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "c2 :", c2)
        '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "s2 :", s2)
        '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "cs :", cs)
        '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "ccl :", ccl)
        '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "ci :", ci)
        '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "cj :", cj)
        '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "ai :", ai)
        '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "ao2 :", ao2)
        '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "aj :", aj)
        '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "-----------------------")
    ...
    Private Sub Load_Sj(ByVal j As Byte, ByVal kk As Byte, ByVal stiffval As Double)
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Load_Sj: " + format( j,"0") + " " + format(kk,"0") + " " + format( stiffval,"0.0000"))
    ...
    Private Sub Process_DOF_J1()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Process_DOF_J1 ...")
    ...
    Private Sub Process_DOF_J2()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Process_DOF_J2 ...")
    ...
    Private Sub Process_DOF_J3()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Process_DOF_J3 ...")
    ...
    Private Sub Process_DOF_K1()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Process_DOF_K1 ...")
    ...
    Private Sub Process_DOF_K2()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Process_DOF_K2 ...")
    ...
    Private Sub Process_DOF_K3()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Process_DOF_K3 ...")
    ...
    Private Sub Assemble_Struct_Stiff_Matrix(ByVal i As Byte)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Assemble_Struct_Stiff_Matrix ..." + format(i,"0"))
        ...
        'frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & (j3, j2, j1, k3, k2, k1)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Assemble_Struct_Stiff_Matrix")
...
ErrHandler_Calc_Moments:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Calc_Moments: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
    ...
    Private Sub Combine_Joint_Loads(ByVal kMember As Byte)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("STEP:1")
        cosa = rot_mat(k, ndx1)
        sina = rot_mat(k, ndx2)
...
ErrHandler_Combine_Joint_Loads:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Combine_Joint_Loads: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
...
ErrHandler_Calc_FE_Forces:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Calc_FE_Forces: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
...
ErrHandler_Accumulate_FE_Actions:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Accumulate_FE_Actions: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
...
ErrHandler_Process_FE_Actions:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Process_FE_Actions: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
...
ErrHandler_Do_Axial_Load:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Do_Axial_Load: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
...
ErrHandler_UDL_Slope:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... UDL_Slope: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
...
ErrHandler_Do_Part_UDL:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Do_Part_UDL: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
...
ErrHandler_Do_Point_load:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Do_Point_load: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
...
ErrHandler_Tri_Slope:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Tri_Slope: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
...
ErrHandler_Do_Triangle:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Do_Triangle: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
...
ErrHandler_Do_Distributed_load:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Do_Distributed_load: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
...
ErrHandler_Get_FE_Forces:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Get_FE_Forces: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
...
ErrHandler_Process_Loadcases:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Process_Loadcases: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
    ...
    Public Sub Zero_Vars()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Zero_Vars ...")
    ...
    Public Sub initialise()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Initialise ...")
        ra = 0
        rb = 0
        global_i = 0
        global_j = 0
    ...
    Private Sub Get_Direction_Cosines()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Get_Direction_Cosines ...")

        'Call schTrace.wbkWriteln("Get_Direction_Cosines ...")

        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("nmb: " + Format(GModel.structParam.nmb, "0"))
        For i = baseIndex To GModel.structParam.nmb - 1
            'frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( i, nmb)
            With GModel.con_grp(i)
                ...
                'frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "STEP:1", i, .jk, getArrayIndex(.jk), .jj, getArrayIndex(.jj)
                ...
                frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & (Format(i, "0") + ": mlen[i]: " + Format(mlen(i), "0.000"))
    ...
    Sub Analyse_Frame()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Analyse_Frame ...")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & (">>> Design Frame Started <<<")
        '    Erase sec_grp
        '    Call Jotter
        '    Call GetData
        ...
        For i = baseIndex To GModel.structParam.nmb - 1
            frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Analyse_Frame:  i = " + format( i,"0"))
        ...
        Next i
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("End of Matrix Assembly")
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("*** Analysis Completed *** ")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Analyse_Frame")
...
ErrHandler_Analyse_Frame:
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... Analyse_Frame: Exit Errors!")
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & Format(Err.Number, "0") & Err.Description
    ...
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "ClearOutputSheet "
    ...
    '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "PrtDeltas "
    ...
    '            '      frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "3 * global_i - 3 = ", 3 * global_i - 3
    '            '      frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "3 * global_i - 2 = ", 3 * global_i - 2
    '            '      frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "3 * global_i - 1 = ", 3 * global_i - 1
    ...
    '        Close()
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "... PrtDeltas: Exit Errors!"
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( Err.Number, Err.Description
    ...
    '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "PrtEndForces "
    ...
    '        Close()
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "... PrtEndForces: Exit Errors!"
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( Err.Number, Err.Description
    ...
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "PrtReactions "
    ...
    '        Close()
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "... PrtReactions: Exit Errors!"
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( Err.Number, Err.Description
    ...
    '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "Prt_Section_Details "
    ...
    '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "PrtSpanMoments "
    ...
    '        Close()
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "... PrtSpanMoments: Exit Errors!"
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( Err.Number, Err.Description
    ...
    '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "PrintResults "
    ...
    '        Close()
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "... PrintResults: Exit Errors!"
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( Err.Number, Err.Description
    ...
    '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "GetData ..."
    ...
    '            r = r + 1
    '      frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( r, njt, nod_grp(njt).x, nod_grp(njt).y
    '        Loop
    ...
    '            r = r + 1
    '      frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( r, nmg
    '        Loop
    ...
    '            r = r + 1
    '      frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( r, nsg
    '        Loop
    ...
    '            r = r + 1
    '      frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( r, nmb
    '        Loop
    ...
    '            r = r + 1
    '      frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( r, nrj
    '        Loop
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "No. Restrained nr .. ", nr
    ...
    '            r = r + 1
    '      frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( r, njl
    '        Loop
    ...
    '            r = r + 1
    '      frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( r, nml
    '        Loop
    ...
    'ErrHandler_GetData:
    '        Close()
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "... GetData: Exit Errors!"
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( Err.Number, Err.Description
    '        '    Resume Exit_GetData
    '        Stop
    ...
    '      frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( tableName, hdrs(i), numRecs(i)
    ...
    '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "wbkDeltas "
    ...
    '        Close()
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "... wbkDeltas: Exit Errors!"
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( Err.Number, Err.Description
    ...
    '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "wbkEndForces "
    '        wbkReport.IncReportRow()
    ...
    '        Close()
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "... wbkEndForces: Exit Errors!"
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( Err.Number, Err.Description
    ...
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "wbkReactions "
    ...
    '        Close()
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "... wbkReactions: Exit Errors!"
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( Err.Number, Err.Description
    ...
    '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "wbkSection_Details "
    ...
    '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "wbkSpanMoments "
    ...
    '        Close()
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "... wbkSpanMoments: Exit Errors!"
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( Err.Number, Err.Description
    ...
    '  frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "wbkReportAnalysisResults "
    ...
    '        Close()
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( "... wbkReportAnalysisResults: Exit Errors!"
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( Err.Number, Err.Description
    ...
    Sub fprintDeltas(ByVal fpRpt As Integer)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("fprintDeltas ...")
    ...
    Sub fprintEndForces(ByVal fpRpt As Integer)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("fprintEndForces ...")
    ...
    Sub fprintReactions(ByVal fpRpt As Integer)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("fprintReactions ...")
    ...
    Sub fprint_Section_Details(ByVal fpRpt As Integer)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("fprint_Section_Details ...")
    ...
    Sub fprintSpanMoments(ByVal fpRpt As Integer)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("fprintSpanMoments ...")
