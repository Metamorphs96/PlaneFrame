...
Public Class clsGeomModel
    ...
    Sub initialiseMaterials()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "Initialise: Materials"
    ...
    Sub initialiseSections()
        Dim i As Integer
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "Initialise: Sections"
    ...
    Sub initialiseNodes()
        Dim i As Integer
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "Initialise: Nodes"
        For i = baseIndex To max_grps
    ...
    Sub initialiseConnectivity()
        Dim i As Integer
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "Initialise: Connectivity"
        For i = baseIndex To max_grps
    ...
    Sub initialiseSupports()
        Dim i As Integer
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "Initialise: Supports"
        For i = baseIndex To max_grps
    ...
    Sub initialiseJointLoads()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "Initialise: Joint Loads"
    ...
    Sub initialiseMemberLoads()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "Initialise: Member Loads"
        For i = baseIndex To numloads
    ...
    Sub initialiseGravityLoads()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "Initialise: Gravity Loads"
    ...
    '------------------------------------------------------------------------------
    Sub cprintjobData()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "cprintjobData ..."
        ProjectData.cprint()
    End Sub

    Sub cprintControlData()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "cprintControlData ..."
        structParam.cprint()
    End Sub
    ...
    Sub cprintNodes()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "cprintNodes ..."
    ...
    Sub cprintConnectivity()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "cprint: Connectivity"
    ...
    Sub cprintMaterials()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "cprint: Materials"
    ...
    Sub cprintSections()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "cprint: Sections"
    ...
    Sub cprintSupports()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "cprint: Supports"
    ...
    Sub cprintJointLoads(ByVal isPrintRaw As Boolean)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "cprint: Joint Loads"
        If isPrintRaw Then
            n = numloads
        Else
            n = structParam.njl
    ...
    Sub cprintMemberLoads()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "cprint: Member Loads"
    ...
    Sub cprintGravityLoads()
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "cprint: Gravity Loads"
        grv_lod.cprint()
    ...
    Sub cprint()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "cprint ..."
    ...
    Sub fgetNodeData(ByVal fp As Integer, ByRef lastTxtStr As String)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "fgetNodeData ..."
        ...
        Do While Not (done) And Not (quit)
            Select Case MachineState
                Case MachineTurnOFF
                    quit = True
                    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "Machine to be Turned OFF"
                Case MachineScanning
                    If Not (EOF(fp)) Then
                        ...
                        Else
                            ...
                            frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "Node= " + dataflds(0)
                            frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "x= " + dataflds(1)
                            frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "y= " + dataflds(2)
    ...
    Sub fgetMemberData(ByVal fp As Integer, ByRef lastTxtStr As String)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "fgetMemberData ..."
    ...
    Sub fgetSupportData(ByVal fp As Integer, ByRef lastTxtStr As String)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & "fgetSupportData ..."
    ...
    Sub fgetMaterialData(ByVal fp As Integer, ByRef lastTxtStr As String)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("fgetMaterialData ...")
    ...
    Sub fgetSectionData(ByVal fp As Integer, ByRef lastTxtStr As String)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("fgetSectionData ...")
    ...
    Sub fgetJointLoadData(ByVal fp As Integer, ByRef lastTxtStr As String)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("fgetJointLoadData ...")
    ...
    Sub fgetMemberLoadData(ByVal fp As Integer, ByRef lastTxtStr As String)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("fgetMemberLoadData ...")
    ...
    Sub fgetGravityLoadData(ByVal fp As Integer, ByRef lastTxtStr As String)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("fgetGravityLoadData ...")
        ...
        Do While Not (done) And Not (quit)
            Select Case MachineState
                Case MachineTurnOFF
                    quit = True
                    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Limit State File Parser Machine to be Turned OFF")
                Case MachineScanning
                    If Not (EOF(fp)) Then
                        s = Trim(Readln(fp))
                        isDataBlockFound = isDataBlockHeaderString(s)
                        ...
                        End If
                    Else
                        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... End of File")
                        done = True
                        MachineState = MachineTurnOFF
                    End If
                Case DataBlockFound
        ...
        If isUseDefaultData Then
            frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Using Default Data")
    ...
    Sub pframeReader00(ByVal fp As Integer)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("pframeReader00 ...")
        ...
        Do While Not (done) And Not (quit)
            ...
            Select Case MachineState
                ...
                Case DataBlockFound
                    ...
                    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("<" & dataCtrlBlk & ">")
                ...
                Case Else
                    If EOF(fp) Then
                        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("DataBlockFound: End Of File")
                        done = True
                        MachineState = MachineTurnOFF
                    Else
                        MachineState = MachineScanning
...
ErrHandler_pframeReader00:
        ...
        FileClose()
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("... pframeReader00: Exit Errors!")
    ...
    Sub SaveDataToTextFile(ByVal fp As Integer)
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("SaveDataToTextFile ...")
        ...
        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("njl= " + format(structParam.njl,"0"))
    ...
    '    For i = 0 To n
    '        '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ( dataShts(i), hdrs(i), numRecs(i)
    ...
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Reading: Nodes...")
    '    r = 0
    '    Do While Not (IsEmpty(dataTable.Offset(r, 1)))
    '        structParam.njt = structParam.njt + 1
    '        Call nod_grp(structParam.njt).wbkRead(dataTable, r)
    '        r = r + 1
    '        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & (r, structParam.njt, nod_grp(structParam.njt).x, nod_grp(structParam.njt).y)
    '    Loop
    ...
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Reading: Materials...")
    '    r = 0
    '    Do While Not (IsEmpty(dataTable.Offset(r, 1)))
    '        structParam.nmg = structParam.nmg + 1
    '        Call mat_grp(structParam.nmg).wbkRead(dataTable, r)
    '        r = r + 1
    '        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & (r, structParam.nmg)
    '    Loop
    'End Sub
    ...
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Reading: Sections...")
    '    r = 0
    '    Do While Not (IsEmpty(dataTable.Offset(r, 1)))
    '        structParam.nsg = structParam.nsg + 1
    '        Call sec_grp(structParam.nsg).wbkRead(dataTable, r)
    '        r = r + 1
    '        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & (r, structParam.nsg)
    '    Loop
    'End Sub
    ...
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Reading: Members...")
    '    r = 0
    '    Do While Not (IsEmpty(dataTable.Offset(r, 1)))
    '        structParam.nmb = structParam.nmb + 1
    '        Call con_grp(structParam.nmb).wbkRead(dataTable, r)
    '        r = r + 1
    '        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & (r, structParam.nmb)
    '    Loop
    ...
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Reading: Supports...")
    '    r = 0
    '    Do While Not (IsEmpty(dataTable.Offset(r, 1)))
    '        structParam.nrj = structParam.nrj + 1
    ...
    '        End With
    '        r = r + 1
    '        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & (r, structParam.nrj)
    '    Loop
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("No. Restrained nr .. ", structParam.nr)
    ...
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Reading: Node Loads...")
    '    r = 0
    '    Do While Not (IsEmpty(dataTable.Offset(r, 1)))
    ...
    '        r = r + 1
    '        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & (r, structParam.njl)
    '    Loop
    ...
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Reading: Member Loads...")
    '    r = 0
    '    Do While Not (IsEmpty(dataTable.Offset(r, 1)))
    ...
    '        r = r + 1
    '        frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & (r, structParam.nml)
    '    Loop
    'End Sub
    ...
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("Reading: Gravity Loads...")
    '    r = 0
    ...
    '    frmTracer.txtTracer.Text = frmTracer.txtTracer.Text & vbCrLf & ("wbkGetData ...")
