...
Function isAlpha(ch As String) As Boolean
  Dim c As Integer
...
Function isUpper(ch As String) As Boolean
  Dim c As Integer
...
Function isLower(ch As String) As Boolean
  Dim c As Integer
...
Function isPrint(ch As String) As Boolean
  Dim c As Integer
...
Function isCntrl(ch As String) As Boolean
  Dim c As Integer
...
Function isAlnum(ch As String) As Boolean
...
Function isPunct(ch As String) As Boolean
